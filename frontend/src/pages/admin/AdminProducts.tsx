                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {products.map((product) => (
                        <div key={product.id} className="bg-marzetti-card p-4 rounded-lg shadow-lg">
                            ...
                            <p className="text-sm text-marzetti-text-secondary">Categoría: {product.category}</p>
                            <div className="flex gap-2 mt-4">
                                <Button onClick={() => handleEdit(product)} variant="outline" size="sm">
                                    <Edit className="h-4 w-4 mr-1" />
                                    Editar
                                </Button>
                                <Button onClick={() => handleDelete(product.id)} variant="outline" size="sm" className="text-red-500">
